...
$sel1="select * from `user` where date BETWEEN '2020-01-01 12:38:28' and '2020-01-31 12:39:02'";
$qry1=mysqli_query($con,$sel1);
$jan=mysqli_num_rows($qry1);
echo $jan;

$sel2="select * from `user` where date BETWEEN '2020-02-01 12:38:28' and '2020-02-28 12:39:02'";
$qry2=mysqli_query($con,$sel2);
$feb=mysqli_num_rows($qry2);

$sel3="select * from `user` where date BETWEEN '2020-03-01 12:38:28' and '2020-03-31 12:39:02'";
$qry3=mysqli_query($con,$sel3);
$mar=mysqli_num_rows($qry3);

$sel4="select * from `user` where date BETWEEN '2020-04-01 12:38:28' and '2020-04-30 12:39:02'";
$qry4=mysqli_query($con,$sel4);
$apr=mysqli_num_rows($qry4);

$sel5="select * from `user` where date BETWEEN '2020-04-01 12:38:28' and '2020-04-31 12:39:02'";
$qry5=mysqli_query($con,$sel5);
$may=mysqli_num_rows($qry5);

$sel6="select * from `user` where date BETWEEN '2020-05-01 12:38:28' and '2020-05-30 12:39:02'";
$qry6=mysqli_query($con,$sel6);
$jun=mysqli_num_rows($qry6);

$sel7="select * from `user` where date BETWEEN '2020-06-01 12:38:28' and '2020-06-31 12:39:02'";
$qry7=mysqli_query($con,$sel7);
$jul=mysqli_num_rows($qry7);

$sel8="select * from `user` where date BETWEEN '2020-07-01 12:38:28' and '2020-07-31 12:39:02'";
