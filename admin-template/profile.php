            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-5 col-8 text-right m-b-30">
                        <a href="index.php?page=doctor&d_id=<?php echo $row['d_id']; ?>" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Edit Profile</a>
                    </div>
                </div>
                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <img class="avatar" src="<?php echo'upload/doctor/'.$row['profile']; ?>" >
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 m-b-0"><?php echo $row['fname']; ?></h3>
                                                <!-- <small class="text-muted">Gynecologist</small> -->
                                                <div class="staff-id">Doctor ID : DR-0001</div>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <span class="text"><?php echo $row['mobile']; ?></span>
                                                </li>
                                                <li>
...
<!-- Mirrored from dreamguys.co.in/demo/medifab/admin-template/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Dec 2019 14:58:43 GMT -->
</html>