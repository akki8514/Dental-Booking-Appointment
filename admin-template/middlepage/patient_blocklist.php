                            ...
                            <div class="card-block">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                       <?php 
                                       $i = 1;
                                       $DataPatient = "SELECT * FROM `patient` WHERE `status` = 'inactive' ";
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td > 
                                                <a href="index.php?page=patient_action&action=unblock&p_id=<?php echo $RowPatient->p_id; ?>">
                                                <span class="custom-badge status-red"><?php echo ucfirst($RowPatient->status); ?> </span></a>
                                            </td>
                                            <td>
