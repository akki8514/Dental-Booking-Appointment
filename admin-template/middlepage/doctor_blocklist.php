                        ...
                        <div class="table-responsive">
							<table class="datatable table table-stripped ">
                                ...
                                <tbody>
                                    <?php 
                                    $i = 1;
                                       $DataDoctor = "SELECT * FROM `doctor` WHERE `status` = 'inactive' ";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- <span class="custom-badge status-green"><?php echo $RowDoctor->status; ?></span> -->
                                            <a href="index.php?page=doctor_action&action=unblock&d_id=<?php echo $RowDoctor->d_id; ?>">
                                            <span class="custom-badge status-red"><?php echo ucfirst($RowDoctor->status); ?></span>  
                                            </a>
                                        </td>
                                        <td>
