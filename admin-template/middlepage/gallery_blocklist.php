                            ...
                            <div class="card-block">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                       <?php 
                                       $i = 1;
                                       $DataGallery = "SELECT * FROM `gallery` WHERE `status` = 'inactive' ";
                                       ...
                                       ?>
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $RowGallery->gname; ?></td>
                                            <td>
                                                <img height=50 width=50 src="<?php echo "upload/gallery/".$RowGallery->profile; ?>">
                                            </td>
                                            <td><a href="index.php?page=gallery_action&action=unblock&g_id=<?php echo $RowGallery->g_id; ?>"><span class="custom-badge status-red"><?php echo ucfirst($RowGallery->status); ?></span></a></td>
                                            <td>
