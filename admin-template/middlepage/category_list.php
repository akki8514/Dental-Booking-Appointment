                            ...
                            <div class="card-block">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                       <?php 
                                       $i = 1;
                                       $Datacategory = "SELECT * FROM `category` WHERE `status` = 'active' ";
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td><?php echo $Rowcategory->description1; ?></td>
                                            <td>
                                                <img height=50 width=50 src="<?php echo "upload/category/".$Rowcategory->profile; ?>">
                                            </td>
                                            <td>
                                                <img height=50 width=50 src="<?php echo "upload/icon/".$Rowcategory->icon; ?>">
                                            </td>
                                            <td>
                                                <a href="index.php?page=category_action&action=status&cat_id=<?php echo $Rowcategory->cat_id; ?>">
