                            ...
                            <div class="card-block">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                       <?php 
                                       $i = 1;
                                       $DataBlog = "SELECT * FROM `blog` WHERE `status` = 'active' ";
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="index.php?page=blog_action&action=status&b_id=<?php echo $RowBlog->b_id; ?>">
                                                    <span class="custom-badge status-green"><?php echo ucfirst($RowBlog->status); ?>
                                                    </span>
                                                </a>
                                            </td>
                                            <td>
